...
<html>
    ...
    <center>
        ...
        <h1>
            <c:if test="${requestScope.op=='nuevo'}" var="res" scope="request">Registro de
            </c:if>
            <c:if test="${requestScope.op=='modificar'}" var="res" scope="request">Modificar
            </c:if>
            tarea
        </h1>
        </fieldset>
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" name="id" 
                                values="<jsp:getProperty name="miTarea" property="id" />"/>
                    </td>
                </tr>
                <tr>
                    <td>Tarea</td>
